...
import { MessageArraySchema, Message, MessageSchema } from '@/lib/validators/message'
...
const ChatInput: FC<ChatInputProps> = ({className, ...props}) => {
    ...
    return ( 
        <div {...props} className={cn('border-t border-zinc-300', className)}>
            <div className="relative mt-4 flex-1 overflow-hidden rounded-[0.3rem] border-none outline-none">
